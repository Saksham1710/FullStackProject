...
const ProductPageComponent = ({productId,userId}) => {// Extract productId from URL params
  ...
  const handleAddToCart = async() => {
    ...
    if (product) {
      ...
      const response = await fetch('https://full-stack-project-backend.vercel.app/api/v1/users/coffee/cart/add', {
                method: 'POST',
                credentials: 'include',
                headers: {
