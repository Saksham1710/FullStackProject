...
const ProductPageComponent = ({productId}) => {// Extract productId from URL params
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        console.log('coffees', SingleRaay);
        console.log('Product ID:'+ productId);
        const selectedProduct = SingleRaay.find(coffee => coffee.id === parseInt(productId));
        if (selectedProduct) {
      ...
      <div className="row">
        ...
        <div className="col-md-6">
          <div className="product-details">
            ...
            <p style={{ fontSize: '20px', fontWeight: 'bold', color: '#333', marginBottom: '20px' }}>Price: ${calculatePrice()}</p>
