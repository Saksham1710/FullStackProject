...
import '../styles/Card.css'; // Import the CSS file from the styles folder
...
const Card = (props) => {
    ...
    const { title, description, imageUrl, price, rating, id, roastType } = props;
                ...
                <div className="card" style={{ width: "300px", height: "560px", }}>
                    <div>
                        ...
                        <div className="card__content">
                            ...
                            <div className="card__roast-type">Roast Type:<br/> {roastType}</div>
                        </div>
